...
{cite}`pareto1896cours`{cite}`benhabib2018skewed`{cite}`axtell2001zipf`{cite}`gabaix2016power`{cite}`mandelbrot1963variation`{cite}`rachev2003handbook`{cite}`rozenfeld2011area`{cite}`gabaix2016power`* the income distributions and the wealth distribution (see, e.g., , ),
* the firm size distribution (, }),
* the distribution of returns on holding assets over short time horizons (, ), and
...
{cite}`acemoglu2002political`{cite}`glaeser2003injustice`{cite}`bhandari2018inequality`{cite}`ahn2018inequality`* see, e.g., , ,  or .
