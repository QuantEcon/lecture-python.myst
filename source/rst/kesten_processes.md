...
{cite}`buraczewski2016stochastic`* See, for example, theorem 2.1.3 of , which provides slightly weaker conditions.
...
{cite}`evans1987relationship`{cite}`hall1987relationship`{cite}`dunne1989growth`1. small firms grow faster than large firms (see, e.g.,  and ) and
