...
For Q-learning, the object that is learned is not quite the __value function__ that is a focus
...
We get appropriate code by modifying some code from  the second part of {doc}`this quantecon lecture <mccall_model>`.
