...
{doc}`This quantecon lecture <rand_resp>` describe randomized response surveys in the tradition of Warner {cite}`warner1965randomized` that are designed  to protect  respondents' privacy. 
