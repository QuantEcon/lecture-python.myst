...
In this this sequel {doc}`cass_fiscal_2`, we  study a two-country version of our one-country model  that is closely related to  {cite:t}`mendoza1998international`.
